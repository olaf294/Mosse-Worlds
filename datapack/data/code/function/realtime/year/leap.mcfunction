...
# February
execute unless score .date time matches 30.. run return run scoreboard players operation .day time = .date time
execute if score .date time matches 30.. run scoreboard players add .month time 1
execute if score .date time matches 30.. run scoreboard players remove .date time 29
