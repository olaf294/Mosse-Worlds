...
data modify entity @n[type=text_display,tag=polish_world] text.text set value "PolishKrowa is in \""
data modify entity @n[type=text_display,tag=polish_world] text.extra[0] set from storage player_detect temp.a.world.response.raw_name
execute if data storage player_detect temp.a{uuid:"lobby"} run data modify entity @n[type=text_display,tag=polish_world] text.extra[0] set value {text:"Lobby",color:gold}

data modify entity @n[type=text_display,tag=polish_world] text.extra[1] set value "\"."


function code:playerdetect/polishkrowa/display_world_macro with storage player_detect temp.a.world.response