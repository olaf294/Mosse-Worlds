...
$http body value '{"content":"<@&1498362077008363661>","embeds":[{"title":"PolishKrowa is online!","description":"PolishKrowa has been detected by the Mosse Worlds Player Detect!",\
