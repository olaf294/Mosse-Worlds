...
data modify entity @n[type=text_display,tag=logbog_world] text.text set value "Logbog is in \""
data modify entity @n[type=text_display,tag=logbog_world] text.extra[0] set from storage player_detect temp.a.world.response.raw_name
execute if data storage player_detect temp.a{uuid:"lobby"} run data modify entity @n[type=text_display,tag=logbog_world] text.extra[0] set value {text:"Lobby",color:gold}

data modify entity @n[type=text_display,tag=logbog_world] text.extra[1] set value "\"."
