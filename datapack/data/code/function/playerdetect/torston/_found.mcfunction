...
# Modify Entity
execute as @e[type=text_display,tag=torston_status] run data modify entity @s text.extra[1].text set value "ᴏɴʟɪɴᴇ"
execute as @e[type=text_display,tag=torston_status] run data modify entity @s text.extra[1].color set value "green"
