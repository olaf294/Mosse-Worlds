...
$http body value '{"content":"<@&1506665815792025681>","embeds":[{"title":"KooriKitsune38 is online!","description":"KooriKitsune38 has been detected by the Mosse Worlds Player Detect!",\
...
scoreboard players set .koori_seen playerdetect 1