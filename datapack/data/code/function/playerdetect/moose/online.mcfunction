...
data modify entity @n[type=text_display,tag=moss_world] text.text set value "Lᴇɢɪᴛᴇʀᴍᴏᴏꜱᴇ ɪꜱ ɪɴ "
...
execute if data storage player_detect a[{players:["Legitermoose"],world:"lobby"}] run data modify entity @n[type=text_display,tag=moss_world] text.extra[0] set value {text:"Lᴏʙʙʏ",color:gold}