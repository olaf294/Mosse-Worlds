...
scoreboard players set .max_seen playerdetect 1

$http body value '{"content":"<@&1506559756335321149>","embeds":[{"title":"mmmmmaaaaaxxxxx is online!","description":"mmmmmaaaaaxxxxx has been detected by the Mosse Worlds Player Detect!",\
