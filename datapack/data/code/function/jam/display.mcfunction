...
"\n  ",{storage:api,nbt:"jam.raw_name",interpret:1b}]
...
tellraw @a[distance=..10] [{text:"ᴊᴀᴍ ɪᴅ: ",color:green},{storage:api,nbt:"jam.jam.id",color:aqua}]
