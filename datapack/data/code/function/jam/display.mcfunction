...
$tellraw @a[tag=!info,distance=..10] [{text:"ᴊᴀᴍ ɪᴅ: ",color:green,click_event:{action:run_command,command:"/world $(world_uuid)"},hover_event:{action:show_text,value:{text:"Wᴏʀʟᴅ UUID: $(world_uuid)",color:green}}},{storage:api,nbt:"temp.jam.id",color:aqua,plain:1b},{text:"  |  ",color:dark_gray},{text:"Cʟɪᴄᴋ ",color:green},{text:"[HERE]",color:gold},{text:" ᴛᴏ ᴘʟᴀʏ.\n  ",color:green},{storage:api,nbt:"temp.raw_name",interpret:1b}]
