...
data modify block 992 56 5 Items set value [{Slot:13b,id:"minecraft:grass_block",components:{item_name:{text:"Lobby",color:white},lore:[{text:"Join and type /edit to change the description!",italic:0b,color:gray},"",\
