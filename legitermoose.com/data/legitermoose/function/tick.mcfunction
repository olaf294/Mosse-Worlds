...
execute positioned 0 64 0 run gamemode adventure @a[distance=..300,tag=!is_admin]
execute positioned 0 64 0 run scoreboard players set @a[distance=..300] worldid -1
execute positioned 0 64 0 as @a[distance=300..] run function legitermoose:util/get_worldid
...
execute positioned 1000 64 0 as @a[scores={legitermoose.gmc_time=1..},gamemode=creative,distance=..250] run function legitermoose:lobby/_timed_gmc_tick
...
# Searching
execute as @a[scores={world=1..}] store result storage legitermoose:temp search.world_id int 1 run scoreboard players get @s world
execute as @a[scores={world=1..}] run function legitermoose:world/search/find/worldid with storage legitermoose:temp search

execute as @a[scores={visit=1..}] store result storage legitermoose:temp search.player_id int 1 run scoreboard players get @s visit
execute as @a[scores={visit=1..}] run function legitermoose:world/search/find/playerid with storage legitermoose:temp search
