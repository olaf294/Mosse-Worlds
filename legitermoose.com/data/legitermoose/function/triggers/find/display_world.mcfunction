...
execute if data storage legitermoose:temp {find_player:{found_world_id:0}} run return run tellraw @s [{storage:"legitermoose:temp",nbt:playername,color:green,interpret:1b},{text:" ɪꜱ ɪɴ ",color:green},{text:"ʟᴏʙʙʏ",color:green}]
