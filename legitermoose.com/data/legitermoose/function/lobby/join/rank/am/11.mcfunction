...
{storage:str,nbt:"out[3]",color:"#89E8A5"},\
{storage:str,nbt:"out[4]",color:"#91EBAC"},\
{storage:str,nbt:"out[5]",color:"#9AEEB2"},\
{storage:str,nbt:"out[6]",color:"#A2F0B8"},\
{storage:str,nbt:"out[7]",color:"#AAF3BF"},\
{storage:str,nbt:"out[8]",color:"#B2F6C5"},\
