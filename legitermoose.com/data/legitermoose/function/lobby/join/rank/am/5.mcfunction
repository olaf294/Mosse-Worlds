...
{interpret:1b,storage:str,nbt:"out[1]",color:"#85E6A2"},\
{interpret:1b,storage:str,nbt:"out[2]",color:"#9AEEB2"},\
{interpret:1b,storage:str,nbt:"out[3]",color:"#AEF5C2"},\
{interpret:1b,storage:str,nbt:"out[4]",color:"#C2FCD2"}]
