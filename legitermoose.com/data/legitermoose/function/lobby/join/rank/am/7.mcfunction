...
{storage:str,nbt:"out[1]",color:"#7FE49D"},\
{storage:str,nbt:"out[2]",color:"#8CE9A7"},\
{storage:str,nbt:"out[3]",color:"#9AEEB2"},\
{storage:str,nbt:"out[4]",color:"#A7F2BD"},\
{storage:str,nbt:"out[5]",color:"#B5F7C7"},\
{storage:str,nbt:"out[6]",color:"#C2FCD2"}]
