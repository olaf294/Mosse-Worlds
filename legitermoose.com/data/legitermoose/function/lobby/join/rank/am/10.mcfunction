...
{storage:str,nbt:"out[1]",color:"#7AE299"},\
{storage:str,nbt:"out[2]",color:"#83E5A0"},\
{storage:str,nbt:"out[3]",color:"#8CE9A7"},\
{storage:str,nbt:"out[4]",color:"#95ECAE"},\
{storage:str,nbt:"out[5]",color:"#9EEFB6"},\
{storage:str,nbt:"out[6]",color:"#A7F2BD"},\
{storage:str,nbt:"out[7]",color:"#B0F6C4"},\
{storage:str,nbt:"out[8]",color:"#B9F9CB"},\
{storage:str,nbt:"out[9]",color:"#C2FCD2"}]
