...
{storage:str,nbt:"out[1]",color:"#78E197"},\
{storage:str,nbt:"out[2]",color:"#7FE49D"},\
{storage:str,nbt:"out[3]",color:"#85E6A2"},\
{storage:str,nbt:"out[4]",color:"#8CE9A7"},\
{storage:str,nbt:"out[5]",color:"#93EBAD"},\
{storage:str,nbt:"out[6]",color:"#9AEEB2"},\
{storage:str,nbt:"out[7]",color:"#A0F0B7"},\
{storage:str,nbt:"out[8]",color:"#A7F2BD"},\
{storage:str,nbt:"out[9]",color:"#AEF5C2"},\
{storage:str,nbt:"out[10]",color:"#B5F7C7"},\
{storage:str,nbt:"out[11]",color:"#BBFACD"},\
{storage:str,nbt:"out[12]",color:"#C2FCD2"}]
