...
{storage:str,nbt:"out[1]",color:"#7DE39B"},\
{storage:str,nbt:"out[2]",color:"#88E7A4"},\
{storage:str,nbt:"out[3]",color:"#94EBAD"},\
{storage:str,nbt:"out[4]",color:"#9FF0B7"},\
{storage:str,nbt:"out[5]",color:"#ABF4C0"},\
{storage:str,nbt:"out[6]",color:"#B6F8C9"},\
{storage:str,nbt:"out[7]",color:"#C2FCD2"}]
