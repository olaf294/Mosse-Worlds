...
{storage:str,nbt:"out[1]",color:"#7BE39A"},\
{storage:str,nbt:"out[2]",color:"#85E6A2"},\
{storage:str,nbt:"out[3]",color:"#8FEAAA"},\
{storage:str,nbt:"out[4]",color:"#9AEEB2"},\
{storage:str,nbt:"out[5]",color:"#A4F1BA"},\
{storage:str,nbt:"out[6]",color:"#AEF5C2"},\
{storage:str,nbt:"out[7]",color:"#B8F8CA"},\
{storage:str,nbt:"out[8]",color:"#C2FCD2"}]
