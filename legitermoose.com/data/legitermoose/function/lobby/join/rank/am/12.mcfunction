...
{storage:str,nbt:"out[1]",color:"#78E298"},\
{storage:str,nbt:"out[2]",color:"#80E49E"},\
{storage:str,nbt:"out[3]",color:"#87E7A3"},\
{storage:str,nbt:"out[4]",color:"#8EEAA9"},\
{storage:str,nbt:"out[5]",color:"#96ECAF"},\
{storage:str,nbt:"out[6]",color:"#9DEFB5"},\
{storage:str,nbt:"out[7]",color:"#A5F1BB"},\
{storage:str,nbt:"out[8]",color:"#ACF4C1"},\
{storage:str,nbt:"out[9]",color:"#B3F7C6"},\
{storage:str,nbt:"out[10]",color:"#BBF9CC"},\
{storage:str,nbt:"out[11]",color:"#C2FCD2"}]
