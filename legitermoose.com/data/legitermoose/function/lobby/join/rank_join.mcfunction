...
execute if entity @s[tag=!is_am] run tellraw @a[tag=legitermoose.is_playing] [{text:"[",color:gray},{text:"+",color:dark_green},{text:"] ",color:gray},{storage:"legitermoose:temp",nbt:playername,interpret:1b}]
execute if entity @s[tag=!is_am] run return run tellraw @a[tag=!legitermoose.is_playing] [{text:"[",color:gray},{text:"→",color:aqua},{text:"] ",color:gray},{storage:"legitermoose:temp",nbt:playername,interpret:1b}]
