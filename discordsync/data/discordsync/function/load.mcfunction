...
scoreboard objectives add ds.config trigger
scoreboard objectives add ds.style dummy

# Load message
execute if data storage discordsync:data data.token run schedule function discordsync:load/load_init 10
