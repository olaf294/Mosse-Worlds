...
execute as @s at @s run function wc:wand/private/particle/prep/1 with storage wc:blocks particle
...
execute as @s at @s run function wc:wand/private/particle/prep/2 with storage wc:blocks particle